...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'total_records'); ?>
		<?php echo $form->textField($model,'total_records'); ?>
		<?php echo $form->error($model,'total_records'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'processed_record'); ?>
		<?php echo $form->textField($model,'processed_record'); ?>
		<?php echo $form->error($model,'processed_record'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'date_done'); ?>
		<?php echo $form->textField($model,'date_done'); ?>
		<?php echo $form->error($model,'date_done'); ?>
	</div>
