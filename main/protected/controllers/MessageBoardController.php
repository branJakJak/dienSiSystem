...
class MessageBoardController extends DncMainController
{
	/**
    ...
    public function actionUpdateStatus()
    {
        ...
        if(isset($_POST['MessageBoard']))
        {
            ...
            if( $model->save()  ){
            	Yii::app()->user->setFlash('success', '<strong>MessageBoard Updated!</strong> You have successfully update the message board.');
	    	}
        }
	...
	{
		$dataProvider=new CActiveDataProvider('MessageBoard');
